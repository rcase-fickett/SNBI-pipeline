...
ITEMS = [
    ...
    dict(id="B.N.01",  name="Navigable Waterway",                         table=FEATURE,  brm_col=None, applies_to="W",     page_types=[PAGE_NOTES, PAGE_PLAN, PAGE_VICINITY], notes="Y/N/U. Look for USCG permit refs. Small creeks generally N."),
