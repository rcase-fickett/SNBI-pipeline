...
ITEMS = [
    ...
    dict(id="B.N.02",  name="Navigation Min Vertical Clearance",          table=FEATURE,  brm_col=None, applies_to="W",     page_types=[PAGE_PLAN, PAGE_CLEARANCE],        errata_pages=[210],       notes="Only if B.N.01=Y. Requires USCG permit datum."),
    ...
    dict(id="B.N.04",  name="Navigation Channel Width",                   table=FEATURE,  brm_col=None, applies_to="W",     page_types=[PAGE_PLAN, PAGE_CLEARANCE],        errata_pages=[213],       notes="Only if B.N.01=Y. USCG permit plans or field measurement."),
