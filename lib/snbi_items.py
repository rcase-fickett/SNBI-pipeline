...
ITEMS = [
    ...
    dict(id="B.N.02",  name="Navigation Min Vertical Clearance",          table=FEATURE,  brm_col=None, applies_to="W",     page_types=[],                                 errata_pages=[],          default_confidence=FIELD_REQ, notes="Only if B.N.01=Y. Sourced from BrM (InfoBridge NBI 39) — plan extraction skipped. Always flagged FIELD_REQ for inspector verification."),
    dict(id="B.N.03",  name="Movable Bridge Max Nav Vertical Clearance",  table=FEATURE,  brm_col=None, applies_to="W",     page_types=[PAGE_PLAN],                        errata_pages=[212],       notes="Only if B.N.01=Y AND movable bridge."),
    dict(id="B.N.04",  name="Navigation Channel Width",                   table=FEATURE,  brm_col=None, applies_to="W",     page_types=[],                                 errata_pages=[],          default_confidence=FIELD_REQ, notes="Only if B.N.01=Y. Sourced from BrM (InfoBridge NBI 40) — plan extraction skipped. Always flagged FIELD_REQ for inspector verification."),
    dict(id="B.N.05",  name="Navigation Channel Min Horizontal Clearance",table=FEATURE,  brm_col=None, applies_to="W",     page_types=[PAGE_PLAN],                        errata_pages=[215],       notes="Only if B.N.01=Y. 0 if piers form channel limits."),
    dict(id="B.N.06",  name="Substructure Navigation Protection",         table=FEATURE,  brm_col=None, applies_to="W",     page_types=[PAGE_PLAN, PAGE_BENT],             errata_pages=[217],       notes="Only if B.N.01=Y. Field inspection usually required."),
