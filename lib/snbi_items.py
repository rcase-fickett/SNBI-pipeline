...
ITEMS = [
    ...
    dict(id="B.N.05",  name="Navigation Channel Min Horizontal Clearance",table=FEATURE,  brm_col=None, applies_to="W",     page_types=[PAGE_PLAN],                        errata_pages=[215],       needs_field=True, notes="Only if B.N.01=Y. 0 if piers form channel limits."),
